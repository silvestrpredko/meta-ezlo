...
PACKAGECONFIG ??= "proxy threaded-resolver zlib"
PACKAGECONFIG_class-native = "ipv6 proxy threaded-resolver zlib"
PACKAGECONFIG_class-nativesdk = "ipv6 proxy threaded-resolver zlib"
...
DEPENDS_append_class-target = " boringssl"
DISABLE_STATIC_class-target = ""
EXTRA_OECONF_append_class-target = " \
    --with-ssl=${STAGING_DIR_TARGET}${libdir}/boringssl \
    --disable-shared \
    --enable-static \
"
